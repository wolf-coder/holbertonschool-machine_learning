#!/usr/bin/env python3
"""
calculating the intersection of obtaining this data with
...
raise a ValueError with the message All values in {P} must be in the range
[0, 1] where {P} is the incorrect variable
    If Pr does not sum to 1, raise a ValueError with the
message Pr must sum to 1 Hint: use numpy.isclose
