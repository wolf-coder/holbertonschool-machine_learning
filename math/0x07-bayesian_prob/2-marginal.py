#!/usr/bin/env python3
"""
Calculating the marginal probability of obtaining the data.
"""
...
the message All values in {P} must be in the range [0, 1] where {P}
...
to 1
    ...
    """
    #  Note: all the exceptions are already dealt with in `intersection` module
    Marginal_probability = sum(intersection(x, n, P, Pr))
